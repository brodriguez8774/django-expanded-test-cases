...
def run_tests_with_pytest_and_coverage(args, extra_args, script_dir):
    ...
    return_code = run_tests_with_pytest_and_create_coverage_data(extra_args)
...
def run_tests_with_pytest_and_create_coverage_data(extra_args):
    """Run tests with pytest and create coverage data."""
...
def create_html_coverage_report(script_dir, lt_100=False):
    ...
    path = f"{script_dir}/.django_expanded_test_cases_coverage_html_report"
