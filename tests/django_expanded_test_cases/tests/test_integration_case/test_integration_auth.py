...
class IntegrationClassTest__NoAutoGeneratedUser(IntegrationTestCase):
    ...
    def test__class_users(self):
        ...
        self.assertFalse(hasattr(self, 'test_admin'))
        self.assertFalse(hasattr(self, 'test_user'))
        self.assertFalse(hasattr(self, 'test_inactive_user'))


class IntegrationClassTest__GenerateUsersInTestData(IntegrationTestCase):
    """Tests for IntegrationTestCase class, specifically with no auto-generated users."""
    ...
    def test__class_users(self):
        ...
        self.assertTrue(hasattr(self, 'test_superuser'))
        self.assertTrue(hasattr(self, 'test_admin'))
        self.assertTrue(hasattr(self, 'test_user'))
        self.assertTrue(hasattr(self, 'test_inactive_user'))
